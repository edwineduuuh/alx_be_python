...
# The operation parameter accepts four possible values: 'add', 'subtract', 'multiply', 
# or 'divide'.
# The function should execute the arithmetic operation based on the operation 
# parameter and the numerical values provided.
