...
annual_savings = int(monthly_savings * 12)
savings_with_interest = (annual_savings * 0.05 * 1) + annual_savings

print(f"Your monthly savings are ${monthly_savings}")
print(f"Projected savings after one year, with interest, is: ${savings_with_interest}")